<?php
/**
 * Nav Menu Walker Class for Reign WP
 */

class ReignNavWalker extends Walker_Nav_Menu
{
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if(isset($args->walker->has_children) && $args->walker->has_children) $classes[] = 'dropdown';
