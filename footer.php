            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        ...
                        <p class="copyright text-xs-center"><?php echo (isset($left_column_text) && $left_column_text != '') ? $left_column_text : '&copy; 2015 <a href="https://www.themewagon.com">Themewagon</a>'; ?></p>
                    </div>
